...
public class MiniJavaGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "INT", "NEW", "ELSE", 
			"IF", "WHILE", "BOOLEAN", "PUBLIC", "THIS", "RETURN", "EXTENDS", "VOID", 
			"CLASS", "STATIC", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", 
			"RBRACK", "SEMI", "COMMA", "DOT", "ASSIGN", "AND", "LT", "BANG", "ADD", 
			"SUB", "MUL", "WS", "COMMENT", "LINE_COMMENT", "IDENTIFIER", "INTEGER_LITERAL", 
